 ...
 * <p>
 * 快排因为用到了递归操作，所以在简单排序中性能不如直接插入排序 * 而在大量数据排序时，递归产生的性能影响对于算法的整体性能优势可以忽略
 * <p> * 时间复杂度分析： * 最坏情况：待排序为正序或逆序，这样每次分割后的子序列一个之比上一次序列少一个元素，一个为空
...
public class QuickSort {
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(a));
        System.out.println("快速排序运行时间为： "+(endTime - startTime) + " ms");

        //使用API里面的快速排序（双轴快速排序）
        long startTime1 = System.currentTimeMillis();
        Arrays.sort(a, 0, a.length-1);
        long endTime1 = System.currentTimeMillis();
        System.out.println("双轴快速排序运行时间为： "+(endTime1 - startTime1) + " ms");
    }
